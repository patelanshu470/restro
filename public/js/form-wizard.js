(function (jQuery) {
    ...
    $(document).ready(function() {
        ...
        $(".file-upload-logos").on("change", function() {
            ! function(e) {
            ...
            $(".file-upload-test").click()
        })
    }),
    // attention: 
    $(document).ready(function() {
        $(".favicon_icon_cover").on("change", function() {
            ! function(e) {
                if (e.files && e.files[0]) {
                    var t = new FileReader;
                    t.onload = function(e) {
                        $(".favicon_icon_cover_img").attr("src", e.target.result)
                    }, t.readAsDataURL(e.files[0])
                }
            }(this)
        }), $(".upload-button").on("click", function() {
    ...
    $(document).ready(function() {
        $(".file-upload-test").on("change", function() {
            ! function(e) {
                if (e.files && e.files[0]) {
                    var t = new FileReader;
                    t.onload = function(e) {
    ...
    $(document).ready(function() {
        $(".bg_banner_cover").on("change", function() {
            ! function(e) {
                if (e.files && e.files[0]) {
                    var t = new FileReader;
                    t.onload = function(e) {
                        $(".bg_banner").attr("src", e.target.result)
                    }, t.readAsDataURL(e.files[0])
                }
            }(this)
        }), $(".upload-button").on("click", function() {
        ...
        $(".file-upload-logo").on("change", function() {
            ! function(e) {
                if (e.files && e.files[0]) {
                    var t = new FileReader;
                    t.onload = function(e) {
                        $(".logo_pics").attr("src", e.target.result)
                    }, t.readAsDataURL(e.files[0])
                }
            }(this)
        }), $(".upload-logo-buttons").on("click", function() {
