...
@section('page-style')
    ...
    <style>
        ...
        .profile-img3 .profile-img41 img {
            max-width: 400px;
            width: 400px;
            height: 340px;
        }
...
@section('content')
    ...
    <main class="main-content">
        ...
        <div class="banner-bg" 
        @if($bg_banner)
         style="background-image: url('{{ $bg_banner->img ? URL::asset('images/promotion/' . $bg_banner->img) : asset('images/layouts/01.png') }}');"
        @else
         style="background-image: url('{{  asset('images/layouts/01.png') }}');"
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <div class="card" data-iq-gsap="onStart" data-iq-opacity="0" data-iq-position-y="-40"
                            ...
                            {{-- large banner --}}
                            <a
                                @if ($promotion_large) href="{{ $promotion_large->link }}"
                            @else
                            href="#" @endif>
                                <div class="hero-image p-3"
                                    @if ($promotion_large) style="padding: 1.8rem 0.5rem !important;background-image: url('{{ $promotion_large->img ? URL::asset('images/promotion/' . $promotion_large->img) : asset('images/layouts/01.png') }}'); background-position:center; background-repeat:no-repeat; background-size:cover">
                            @else
                            style="padding: 1.8rem 0.5rem !important;background-image: url('{{ asset('images/layouts/01.png') }}'); background-position:center; background-repeat:no-repeat; background-size:cover"> @endif>

                                    <div class="card-body p-5" style="margin-bottom: 1rem;">
                                                ...
                                                <div class="banner-text pt-3">
                                                    <h1 class="fw-bold mb-4">
                                                        @if (Auth::check())
                                                            ...
                                                            {{ auth()->user()->last_name }}
                                                        @else
                                                            Hello,have a nice food.
                                                        @endif

                                                    </h1>
                                                </div>
                                                @if ($promotion_large)
                                                    <p class="mb-4"> {{ $promotion_large->description }}</p>
                                                @endif
                                                {{-- <a href="{{ route('user.menu') }}">
                                                    <button type="button" class="btn btn-primary rounded-pill">Check
                                                        Menu</button>
                                                </a> --}}
                                                <div class="cust_div" style="margin: 66px;"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        @if ($promotion_small)
                            <a href="{{ URL::route('user.product', $promotion_small->product_id) }}">
                                ...
                                <div class="card  profile-img3 " data-iq-gsap="onStart" data-iq-opacity="0"
                                    ...
                                    <div class="card-body">
                                        <div class="text-center profile-img51">
                                            <div class="profile-img41 " style="margin-top: 10px;">
                                                <img style="max-width:400px !important;width:400px;height:340px"
                                                    src="{{ $promotion_small->img ? URL::asset('images/promotion/' . $promotion_small->img) : asset('images/layouts/8.png') }}"
                                                    class="img-fluid rounded-pill " alt="profile-image">
                                            </div>
                                            <div class="profile-img51 " style="    margin-top: 16rem;">
                                                <h2 class="mb-2 profile-img55">{{ $promotion_small->offer }}</h2>
                                                <p class="mb-0">{{ $promotion_small->name }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @else
                            <div class="card  profile-img3 " data-iq-gsap="onStart" data-iq-opacity="0"
                                ...
                                <div class="card-body">
                                    <div class="text-center profile-img51">
                                        <div class="profile-img41 " style="margin-top: 0;">
                                            <img src="images/layouts/8.png" class="img-fluid rounded-pill "
                                                alt="profile-image">
                                        </div>
                                        <div class="profile-img51 " style="    margin-top: 16rem;">
                                            <h2 class="mb-2 profile-img55">50 %
                                                off </h2>
                                            <p class="mb-0">The full price of
                                                burgers</p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="content-inner mt-4 pt-4">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-xs-12">
                    ...
                    <div class="card-transparent bg-transparent mb-0">
                        <div class="card-header border-0  ">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3>Menu category</h3>
                                <a href="{{ route('cat.view') }}" class="text-dark d-flex">View
                                    All
                        ...
                        <div class="card-body">
                            <div
                                class="swiper-container d-slider2 swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                                <div class="swiper-wrapper" id="swiper-wrapper-bdeaf8d4b6f06693" aria-live="polite"
                                    style="transform: translate3d(0px, 0px, 0px);">


                                    @foreach ($category as $item)
                                        <div class="swiper-slide" role="group" aria-label="5 / 8"
                                            style="width: 125.571px; margin-right: 40px;">
                                            <div class="card category-menu" data-iq-gsap="onStart" data-iq-opacity="0"
                                                ...
                                                <form action="{{ route('user.product_list') }}" method="get"
                                                    id="cat_list_form_submit{{ $item->id }}">

                                                    <div class="card-body" id="cat_list_form{{ $item->id }}">
                                                        <div class="text-center iq-menu-category">
                                                            <img style="width: 106px;height: 106px !important;"
                                                                src="{{ $item->cat_img ? URL::asset('images/restaurant/category/' . $item->cat_img) : asset('no-image.jpg') }}"
                                                                alt="header" class="img-fluid rounded-pill mb-3">
                                                            <h6 class="heading-title fw-bolder pb-4">
                                                                {{ $item->name }}
                                                            </h6>
                    ...
                    <div class="card-transparent bg-transparent mb-0">
                        ...
                        <div class="card-body p-0 dish-card-vertical">
                            <div class="swiper swiper-container d-slider4">
                                <div class="swiper-wrapper" id="swiper-wrapper-cbab35a61759e68d" aria-live="polite"
                                    ...
                                    @foreach (collect($popular_product)->chunk(2) as $product_all)
                            ...
                            @foreach ($popular_product as $products)
                                <div class="modal fade" id="exampleModalCenter{{ $products->id }}" tabindex="-1"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-lg-12" top="25">
                                                            <div class="card" data-iq-gsap="onStart"
                                                                data-iq-opacity="0" data-iq-position-y="-40"
                                                                data-iq-duration=".6" data-iq-delay="1.2"
                                                                data-iq-trigger="scroll" data-iq-ease="none">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="my-cart-body">
                                                                        <div
                                                                            class="border border-primary rounded p-3 mt-5">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <h6 class="heading-title fw-bolder">Total
                                                                                </h6>
                                                                                <h6
                                                                                    class="heading-title fw-bolder text-primary">
                                                                                    $<span
                                                                            ...
                                                                            @if ($cart_products != null)
                                                                                @if ($restaurant_cart_id != $products->restaurent_id)
                                                                                    <button type="button"
                                                                                        ...
                                                                                        href="#"
                                                                                        onclick="deleteRecord({{ $products->id }})">Add
                                                                                        To
                                                                                        Cart</button>
                            ...
                            <div class="card-body p-0 dish-card-vertical">
                                <div class="swiper-container d-slider4 ">
                                    <div class="swiper-wrapper" id="swiper-wrapper-cbab35a61759e68d" aria-live="polite"
                                        ...
                                        @foreach (collect($product)->chunk(2) as $trending_product)
                                            <div class="swiper-slide swiper-slide-active" data-iq-gsap="onStart"
                                                data-iq-opacity="0" data-iq-position-y="-40" data-iq-duration=".6"
                                                data-iq-delay=".4" data-iq-trigger="scroll" data-iq-ease="none"
                                                data-swiper-slide-index="1" role="group" aria-label="2 / 4"
                    ...
                    <div class="col-xl-12 col-lg-12 dish-card-horizontal mt-2">
                        <div class="card-header border-0 m-2 mb-5">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('user.restaurant_list') }}" class="text-dark">View All
                                    <svg width="24" height="24" class="ms-1" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="24" height="24" rx="12" fill="#EA6A12"></rect>
                                        <path d="M10.25 8.5L13.75 12L10.25 15.5" stroke="white" stroke-width="1.5"
                                    ...
                                    <div class="col active" data-iq-gsap="onStart" data-iq-opacity="0"
                                        ...
                                        <div>
                                            <div class="card card-white dish-card profile-img mb-0 ">
                                                ...
                                                <div class="card-body menu-image">
                                                    <h6 class="heading-title fw-bolder mt-4 mb-0">
                                                        {{ $restaurants->restaurant_name }}</h6>
                                                    <span>{{ $restaurants->street }} {{ $restaurants->landmark }}
                                                        {{ $restaurants->pincode }}</span>
                                                    <div class="card-rating stars-ratings">
                                                        <!-- People find pleasure in different ways. I find it in keeping my mind clear. - Marcus Aurelius -->
                ...
                <div class="col-lg-3 col-md-3 col-xs-12">
                    @if ($promotion_gif)
                        <a href="{{ $promotion_gif->link }}">
                            <div class="card">
                                <img src="{{ $promotion_gif->img ? URL::asset('images/promotion/' . $promotion_gif->img) : asset('images/layouts/8.png') }}"
                                    alt class style="border-radius: 20px;">
                            </div>
                        </a>
                    @else
                        <div class="card">
                            <img src="{{ asset('images/Untitled design.gif') }}" alt class style="border-radius: 20px;">
                        </div>
                    @endif

                    <div class="col-md-12 col-lg-12 pt-4">
                        <div class="card iq-glass-card rounded border border-white" data-iq-gsap="onStart"
                            ...
                            <div class="card-body">
                                <div class="iq-col-masonry m-0">
                                    @foreach ($category as $categories)
                                        <form action="{{ route('user.product_list') }}" method="get"
                                            id="left_cat_form{{ $categories->id }}">
                                            <button type="button" id="left_cat{{ $categories->id }}"
                                                class="btn btn-outline-primary rounded iq-col-masonry-block">{{ $categories->name }}</button>
                        ...
                        <div class="position-relative">
                            <img src="images/layouts/40.png" alt="img-1" class="img-fluid img-user">
                        </div>
                    </div>
                </div>
            </div>
