        ...
        <div class="row">
            <div class="card">
                ...
                <div class="col-md-12 col-lg-12">
                    <form method="get" action="{{route('restaurent.profit.loss')}}" >
                    <div class="row">
                        
                        <div class="col-md-12 col-lg-4" style="margin-top: 16px;">
                            <div class="form-group ">
                                <select name="restaurent_id" id="city-dropdown" class="selectpicker form-control"
                                            data-style="py-0" required>
                                            <option selected disabled>Select Restaurant</option>
                                            @foreach ($restaurents as $restro)
                                                <option value="{{$restro->id}}"  {{ request()->input('restaurent_id') == $restro->id ? 'selected' : '' }} >{{$restro->restaurant_name}}</option>
                                            @endforeach
                                </select>
                        ...
                        <div class="col-md-12 col-lg-4" style="margin-top: 16px;display: grid;justify-content: center;">
                            <div class="form-group ">
                                <button type="submit" style="width:288px;" class="btn btn-outline-primary rounded-pill  form-control">Search</button>
                            </div>
