                              ...
                              <div class="form-group col-md-12">
                                <label class="form-label" style="color:white">Category:</label>
                                 <select name="category_id" class="selectpicker form-control" data-style="py-0" style="background: transparent;color: #fff">
                                    ...
                                    @foreach ($category as $categories)
                                    <option value="{{ $categories->id }}" style="color: #686464">{{ $categories->name }}</option>
                                    @endforeach
                                 </select>
                             </div>
                           </div>
                        ...
                        <form method="POST" action="{{ route('subcategory.update',$subcategories->id) }}" id="edit_subcategory{{ $subcategories->id }}">
                           ...
                           <div class="row">
                              <div class="form-group col-md-12">
                                 ...
                                 <input type="text" class="form-control" name="name" value="{{ $subcategories->name }}" id="name" placeholder="Name">
                              </div>
                              <div class="form-group col-md-12">
                                <label class="form-label">Country:</label>
                                 <select name="category_id" class="selectpicker form-control" data-style="py-0">
                                    ...
                                    @foreach ($category as $categories)
                                    <option value="{{ $categories->id }}" {{($categories->id == $subcategories->category_id ) ? 'Selected' : ''}}>{{ $categories->name }}</option>
                                    @endforeach
                                 </select>
                             </div>
                           </div>
