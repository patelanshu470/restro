                ...
                <div class="col-md-12 col-lg-7 col-xl-4">
                    <div class="card-body">
                        ...
                        @php
                            ...
                            $para_no=$mobile->phone_number;
                        @endphp
                        <h2 class="mb-2 text-center">Account Verification</h2>
                        <form method="POST" action="{{ route('otp.getlogin') }}" class="otp-form" name="otp-form" id="validation">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                            ...
                            <p class="mt-3 text-center">
                                Resend OTP?<a class=""  href="{{route('otp.resend',$para_no)}}" style="pointer-events: none; margin-left:5px"  id="resend" >Click Here New OTP</a>
                            </p>
                        </form>
                    </div>
                </div>
