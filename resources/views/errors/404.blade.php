...
<div class="row">
    <div class="col-lg-12">
        ...
        <img src="{{ asset('images/error/01.png') }}" id="error-three" class="img-fluid " alt="">
        <h2 class="mb-0 mt-4">Page Not Found.</h2>
        <p class="mt-2">It seems we can't find what you're looking for. Perhaps searching can help.</p>
