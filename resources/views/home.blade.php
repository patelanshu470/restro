...
<div class="content-inner mt-5 py-0">
    ...
    <div class="card-profile-progress mb-3">
     ...
     <img src="images/layouts/13.png" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image" >
</div>
...
<!-- <div>
<div class="card-profile-progress mb-3">
    <div id="circle-progress-1" class="circle-progress  circle-progress-basic circle-progress-primary" data-min-value="0" data-max-value="100" data-value="" data-type="percent"></div>
    <img src="https://templates.iqonic.design/aprycot/laravel/public/images/layouts/" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image" >
</div>
<div class="text-center">
    <p class="mb-2">65%</p>
    <h6 class="heading-title fw-bolder">Mix Vaggie Pizza</h6>
    ...
    <div class="card-profile-progress mb-3">
     ...
     <img src="images/layouts/11.png" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image" >
</div>
<div class="text-center">
    <p class="mb-2">50%</p>
...
<!-- <div>
<div class="card-profile-progress mb-3">
    <div id="circle-progress-2" class="circle-progress  circle-progress-basic circle-progress-primary" data-min-value="0" data-max-value="100" data-value="" data-type="percent"></div>
    <img src="https://templates.iqonic.design/aprycot/laravel/public/images/layouts/" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image" >
</div>
<div class="text-center">
    <p class="mb-2">50%</p>
    ...
    <div class="card-profile-progress mb-3">
     ...
     <img src="images/layouts/12.png" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image" >
</div>
<div class="text-center">
    <p class="mb-2">55%</p>
...
<!-- <div>
<div class="card-profile-progress mb-3">
    <div id="circle-progress-3" class="circle-progress  circle-progress-basic circle-progress-primary" data-min-value="0" data-max-value="100" data-value="" data-type="percent"></div>
    <img src="https://templates.iqonic.design/aprycot/laravel/public/images/layouts/" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image" >
</div>
<div class="text-center">
    <p class="mb-2">55%</p>
    ...
    <div class="card-profile-progress mb-3">
     ...
     <img src="images/layouts/10.png" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image" >
</div>
<div class="text-center">
    <p class="mb-2">55%</p>
...
<!-- <div>
<div class="card-profile-progress mb-3">
    <div id="circle-progress-4" class="circle-progress  circle-progress-basic circle-progress-primary" data-min-value="0" data-max-value="100" data-value="" data-type="percent"></div>
    <img src="https://templates.iqonic.design/aprycot/laravel/public/images/layouts/" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image" >
</div>
<div class="text-center">
    <p class="mb-2">55%</p>
...
<!-- <div>
<div class="card-profile-progress mb-3">
    <div id="circle-progress-5" class="circle-progress  circle-progress-basic circle-progress-primary" data-min-value="0" data-max-value="100" data-value="" data-type="percent"></div>
    <img src="https://templates.iqonic.design/aprycot/laravel/public/images/layouts/" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image" >
</div>
<div class="text-center">
    <p class="mb-2">65%</p>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="images/avatars/06.png" alt="profile">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                    <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="images/avatars/07.png" alt="profile">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                    <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="images/avatars/08.png" alt="profile">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                    <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="images/avatars/09.png" alt="profile">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                    <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="images/avatars/10.png" alt="profile">
                                    <p class="mb-0">Jane Cooper</p>
                                    </div>
                                </td>
                                <td>
